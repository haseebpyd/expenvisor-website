...
ADMIN_EMAILS=admin@mintflow.com,admin2@mintflow.com
```
...
- [ ] Create separate Vercel project (admin.mintflow.com)
- [ ] Set environment variables in Vercel
- [ ] Deploy to production
- [ ] Test in production environment
- [ ] Set up subdomain (admin.mintflow.com)
...
7. **Separate subdomain** (admin.mintflow.com) - not /admin route
...
- Login: `admin.mintflow.com/login`
- Dashboard: `admin.mintflow.com/dashboard`
- Users: `admin.mintflow.com/dashboard/users`
- Subscriptions: `admin.mintflow.com/dashboard/subscriptions`
- AI Management: `admin.mintflow.com/dashboard/ai-management`
- Configuration: `admin.mintflow.com/dashboard/configuration`
- Analytics: `admin.mintflow.com/dashboard/analytics`
- Support: `admin.mintflow.com/dashboard/support`
...
- [ ] Test all features, secure API routes, and deploy to admin.mintflow.com