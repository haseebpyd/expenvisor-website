...
const plans = [
  {
    ...
    limitations: ["No cloud sync", "No export features", "Limited AI features"],
    popular: false,
    cta: "Get Started",
  },
  {
              ...
              >
                ...
                <div className="text-center mb-8">
                  ...
                  <div className="flex items-baseline justify-center">
                    ...
                    <span className="text-text-secondary-dark ml-2">
                      {plan.period}
                    </span>
                  </div>
                </div>
                ...
                {plan.limitations.length > 0 && (
                  <div className="space-y-2 mb-8">
                    <h4 className="text-sm font-semibold text-text-tertiary-dark mb-2">
                      Limitations:
                    </h4>
                    {plan.limitations.map((limitation) => (
                      <div key={limitation} className="flex items-start">
                        <span className="text-text-tertiary-dark mr-3">•</span>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto text-left">
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-text-secondary-dark text-sm">
                  Yes! Premium comes with a 7-day free trial. No credit card
                  required to start.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-text-secondary-dark text-sm">
                  We accept all major credit cards, PayPal, and Apple Pay/Google
                  Pay through the app stores.
                </p>
              </div>
